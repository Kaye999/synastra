// Transit alert email — Alice heading + Hanken Grotesk body, pull-quote, CTA.
//
...
<html lang="en">
  <head>
    ...
    <style>
      ...
      h1 { font-family: 'Alice', Georgia, serif; font-weight: 600; font-size: 32px; line-height: 1.15; letter-spacing: -0.01em; margin: 0 0 8px; color: #f5f3ea; }
      ...
      blockquote { font-family: 'Alice', Georgia, serif; font-style: italic; font-size: 20px; line-height: 1.4; color: #e8dcb8; border-left: 2px solid #8a7a4e; padding: 8px 0 8px 20px; margin: 28px 0; }
